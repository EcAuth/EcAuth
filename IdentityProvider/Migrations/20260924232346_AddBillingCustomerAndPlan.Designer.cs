...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdentityProvider.Models.AccountBillingPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("B2BTiersJson")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)")
                        .HasColumnName("b2b_tiers_json");

                    b.Property<string>("B2CTiersJson")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)")
                        .HasColumnName("b2c_tiers_json");

                    b.Property<bool>("BillingExempt")
                        .HasColumnType("bit")
                        .HasColumnName("billing_exempt");

                    b.Property<DateTimeOffset>("CreatedAt")
                        .HasColumnType("datetimeoffset")
                        .HasColumnName("created_at");

                    b.Property<long?>("DiscountJpy")
                        .HasColumnType("bigint")
                        .HasColumnName("discount_jpy");
            ...
            modelBuilder.Entity("IdentityProvider.Models.Client", b =>
                {
                    ...
                    b.Property<string>("BillingExemptReason")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)")
                        .HasColumnName("billing_exempt_reason");
            ...
            modelBuilder.Entity("IdentityProvider.Models.MonthlyActiveUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("YearMonth", "OrganizationId");

                    b.HasIndex("YearMonth", "ClientId", "Subject")
                        .IsUnique();

                    b.ToTable("monthly_active_user");
                });
            ...
            modelBuilder.Entity("IdentityProvider.Models.StripeWebhookEvent", b =>
                {
                    ...
                    b.ToTable("stripe_webhook_event");
                });
